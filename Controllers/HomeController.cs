...
using MyFirstModelControllerViewProject.Models;
using MyFirstModelControllerViewProject.Services;

namespace MyFirstModelControllerViewProject.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult ModelCalc()
        {
            ...
            var viewModel = new CalcModel()
            {
                ...
                Div = tempNum2 != 0 ? (tempNum1 / tempNum2).ToString() : "Delenie na noll",
            };
        ...
        public IActionResult ViewDataCalc()
        {
            ...
            ViewData["Div"] = tempNum2 != 0 ? (tempNum1 / tempNum2).ToString() : "Delenie na noll";
        ...
        public IActionResult ViewBagCalc()
        {
            ...
            ViewBag.Div = tempNum2 != 0 ? (tempNum1 / tempNum2).ToString() : "Delenie na noll";
